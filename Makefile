...
PKG_SOURCES	=  ttaglib.c tcltaglib.c
PKG_OBJECTS	=  ttaglib.o tcltaglib.o
...
PKG_LIB_FILE	= libtcltaglib1.1.so
PKG_LIB_FILE8	= libtcltaglib1.1.so
PKG_LIB_FILE9	= libtcl9tcltaglib1.1.so
PKG_STUB_LIB_FILE = libtcltaglibstub1.1.a
...
top_builddir	= /home/danilo/Public/tcltaglib
